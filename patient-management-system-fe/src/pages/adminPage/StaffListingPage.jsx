...
const StaffListingPage = () => {
    ...
    return (
        <div className="min-h-screen font-sans relative overflow-y-auto" style={{ width: '100%', background: `linear-gradient(160deg, ${roleConfig.color}15 0%, ${roleConfig.color}10 50%, #eef2ff 100%)` }}>
            {scrollbarStyles}
