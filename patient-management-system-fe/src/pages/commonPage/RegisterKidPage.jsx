...
const RegisterKidPage = () => {
    ...
    const handleVerifyAndCreate = async (otp) => {
        try {
    ...
    return (
        <div className="min-h-screen w-full bg-[#f0f7ff] flex items-center justify-center p-4 lg:p-8" style={{ width: '100vw', height: '100vh' }}>
                    ...
                    <div className="space-y-10">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div className="relative group md:col-span-3">
                                            ...
                                            <input
                                                ...
                                                className={`w-full pl-12 pr-4 py-4 bg-gray-50 border-2 rounded-2xl focus:bg-white  outline-none transition-all ${!isvalidationEmailParent ? 'border-red-500' : 'focus:border-blue-400'}`}
                                        ...
                                        <div className="relative group">
                                            ...
                                            <select
                                                ref={relationshipRef}
                                                className="w-full pl-12 pr-4 py-4 bg-gray-50 border-2 rounded-2xl focus:bg-white focus:border-blue-400 outline-none transition-all appearance-none"
                                                required
                                                onInvalid={(e) =>
                        ...
                        <div className="pt-4">
                            <button
                                disabled={isLoading}
                                type='submit'
                                className={`w-full bg-gray-800 text-white font-black py-5 rounded-2xl hover:bg-black transition-all shadow-xl active:scale-[0.98] flex items-center justify-center gap-3 group
            ...
            {showOtpModal && (
                <OtpPopUp
                    emailParentRef={emailParentRef}
                    setShowOtpModal={setShowOtpModal}
                    handleVerifyAndCreate={handleVerifyAndCreate}
                    sendRequestRegister={sendRequestRegister}
