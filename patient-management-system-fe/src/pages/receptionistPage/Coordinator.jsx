    ...
    return (
        <main className="flex-1  overflow-y-auto bg-gray-50/30 p-8">
            <div className="flex gap-8">
                ...
                <div className="flex-[7] bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden flex flex-col">
                ...
                <div className="flex-[5] bg-white rounded-2xl border border-gray-200 shadow-sm flex flex-col">
